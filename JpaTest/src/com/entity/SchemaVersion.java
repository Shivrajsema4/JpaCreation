 ...
 */
@Entity
@Table(name = "schema_version", catalog = "osdashboard")
public class SchemaVersion implements java.io.Serializable {
	...
	public SchemaVersion(int installedRank, String description, String type, String script, String installedBy,
	...
	public SchemaVersion(int installedRank, String description, String type, String script, Integer checksum,
	...
	@Column(name = "installed_on", nullable = false, length = 0)
